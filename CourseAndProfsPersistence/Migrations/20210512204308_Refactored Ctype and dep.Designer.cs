...
namespace CourseAndProfsPersistence.Migrations
{
    ...
    [Migration("20210512204308_Refactored Ctype and dep")]
    partial class RefactoredCtypeanddep
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseAndProfsPersistence.Identity.CaPRoles", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourseAndProfsPersistence.Identity.CaPUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourseAndProfsPersistence.Identity.Device", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CourseAndProfsPersistence.Models.Review", b =>
                {
                    ...
                    b.Property<double>("UsersSubjectScore")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CourseAndProfsPersistence.Identity.CaPRoles", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CourseAndProfsPersistence.Identity.CaPUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
